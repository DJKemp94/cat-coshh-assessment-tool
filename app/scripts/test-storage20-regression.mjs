...
const GUIDANCE_30_CASES = [
  ...
  { name: 'Guidance Diethyl Ether', cas: '60-29-7', form: 'liquid', codes: ['H224', 'H302', 'H336', 'EUH019'], pictograms: ['flammable', 'harmful'], bp: 35, expectedZone: 'organicSolventsAcids', expectedCabinet: 'flammables', expectedConstraint: 'Class B peroxide former' },
  { name: 'Guidance Tetrahydrofuran', cas: '109-99-9', form: 'liquid', codes: ['H225', 'H319', 'H335', 'H351', 'EUH019'], pictograms: ['flammable', 'harmful', 'health-hazard'], expectedZone: 'organicSolventsAcids', expectedCabinet: 'flammables', expectedConstraint: 'Class B peroxide former' },
  ...
  { name: 'Guidance Potassium Metal', cas: '7440-09-7', form: 'solid', codes: ['H260', 'H314', 'EUH019'], pictograms: ['flammable', 'corrosive'], expectedZone: 'specialReview', expectedCabinet: 'specialReview', expectedConstraint: 'Class A peroxide former' },
